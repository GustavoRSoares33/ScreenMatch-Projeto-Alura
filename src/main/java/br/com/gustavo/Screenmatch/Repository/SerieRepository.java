package br.com.gustavo.Screenmatch.Repository;

import br.com.gustavo.Screenmatch.Model.Categoria;
import br.com.gustavo.Screenmatch.Model.Episodio;
import br.com.gustavo.Screenmatch.Model.Serie;
...
public interface SerieRepository extends JpaRepository<Serie, Long> {
    ...
    @Query("SELECT e FROM Serie s JOIN s.episodios e WHERE s.titulo = :serie AND YEAR(e.dataLancamento) >= :anoLancamento")
